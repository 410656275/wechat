...
public class HttpUtils {
     ...
     * @throws IOException
     */
    public static String httpGet(String url, String type) throws IOException{
        return sendHttp(url, "GET", null, type);
    }
    ...
    public static String httpPost(String url, String params) throws IOException{
        return sendHttp(url, "POST", params, null);
    }
    ...
    public static String httpPut(String url, String params) throws IOException{
        return sendHttp(url, "PUT", params, null);
    }
     ...
     * @throws IOException
     */
    public static String httpDelete(String url, String type) throws IOException{
        return sendHttp(url, "DELETE", null, type);
    }
    ...
    public static String httpsPost(String url, String params) throws Exception{
        return sendHttps(url, "POST", params);
    }
     ...
     * @throws Exception
     */
    public static String httpsPut(String url, String params) throws Exception{
        return sendHttps(url, "PUT", params);
    }
    ...
    public static String httpsDelete(String url) throws Exception{
        return sendHttps(url, "DELETE", null);
    }
     ...
     * @throws Exception
     */
    private static String sendHttps(String url, String method, String param) throws Exception {
        HashSet<String> methods = new HashSet();
        methods.add("POST");
        methods.add("GET");
        methods.add("PUT");
